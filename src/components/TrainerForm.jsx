...
//     const newErrors = {};
//
//     // Employee ID: must be 9 digits and only numbers
//     if (!formData.employeeId.trim()) {
//       newErrors.employeeId = 'Employee ID is required';
//     } else if (!/^\d{9}$/.test(formData.employeeId.trim())) {
...
//           <p>Enter your details to get your topic assignment</p>
//         </div>
//
